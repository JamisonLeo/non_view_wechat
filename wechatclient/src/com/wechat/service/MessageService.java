...
public class MessageService {
     ...
     * @param sendTime 发送时间
     */
    public static void sendMessageToPersonal(String receiver, String sender, String content, String sendTime) {
     ...
     * @param sendTime 发送时间
     */
    public static void sendMessageToEveryone(String sender, String content, String sendTime) {
        Message message = new Message();
        message.setSender(sender);
        message.setSendTime(sendTime);
     ...
     * @param sendTime 发送时间
     */
    public static void sendFileToPersonal(String receiver, String sender, String filePath, String sendTime) {
        Message message = new Message();
